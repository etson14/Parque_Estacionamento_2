...
public class TelaAdministrativoController implements Initializable {
   ...
   public void carregarTelaCondutor() throws IOException{
       AnchorPane a =(AnchorPane)FXMLLoader.load(getClass().getResource("/parque_estacionamento_2/view/TelaCondutor.fxml"));
       apMP.getChildren().setAll(a);
   }
   ...
   public void carregarTelaCartao() throws IOException{
       AnchorPane a =(AnchorPane)FXMLLoader.load(getClass().getResource("/parque_estacionamento_2/view/TelaCartao.fxml"));
       apMP.getChildren().setAll(a);
   }
   
   public void carregarTelaConsulta() throws IOException{
       AnchorPane a =(AnchorPane)FXMLLoader.load(getClass().getResource("/parque_estacionamento_2/view/TelaConsulta.fxml"));
       apMP.getChildren().setAll(a);
   }
